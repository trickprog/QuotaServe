        ...
        <div className="dashboard_tab_button">
          <ul role="tablist" className="nav flex-column dashboard-list">
            ...
            <li>
              {" "}
              <Link
                to="/vendor/all-product"
                className={
                  location.pathname === "/vendor/all-product" ? "active" : null
                }
              >
                <i className="fa fa-shopping-cart"></i>Product
              </Link>
            </li>
            <li>
              <Link
              ...
              >
                <i className="fa fa-shopping-bag"></i>Order
              </Link>
            </li>
            <li>
              <Link
            ...
            <li>
              ...
              >
                <i className="fa fa-user"></i>Add PRoduct
              </Link>
            </li>
            <li>
              <Link
                to="/vendor/vendor-setting"
                className={
