...
import img4 from "../../../assets/img/product-image/ggg 1.png";
                  ...
                  <div className="col-lg-7 col-md-6 col-sm-12 col-12">
                    <div className="modal_product_content_one">
                      ...
                      <div className="reviews_rating">
                        ...
                        />
                        <span>
                          ({props.data.rating.count} Customer Reviews)
                        </span>
                      </div>
                      <h4>
                        ${props.data.price}.00{" "}
                        <del style={{ fontWeight: 400, color: "gray" }}>
                          ${parseInt(props.data.price) + 17}.00
                        </del>{" "}
                      </h4>
                      ...
                      <div className="modal_share_icons_one">
                        ...
                        <div className="posted_icons_one">
                          <FacebookShareButton
                            url={
                              "https://themeforest.net/item/andshop-ecommerce-react-js-template/33822003"
                            }
                            quote={"Best React.js ecommerce Templete"}
                          >
                          ...
                          <TwitterShareButton
                            ...
                            title={"Best React.js ecommerce Templete"}
                          >
